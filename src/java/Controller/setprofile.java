...
//                    // obtains input stream of the upload file
                ...
                ps.setString(9, quotes);
                ps.setString(10, street);
                ps.setString(11, door);
                ps.setString(12, address);
                ps.setString(13, city);
                ps.setString(14, state);
                ps.setString(15, zip);
                ps.setString(16, achieve);
                ps.setString(17, religious);
                ps.setString(18, political);
                ps.setString(19, interested);
                ps.setString(20, relation);
                ...
                if (inputStream != null) {
                    ...
                    if (i != 0) {
                        ...
                        if (f != 0) {
                            ...
                            out.println("<script>alert('Profile Has Been Set Successfully !!!')\n" + "  window.location.href='index.html';\n" + "</script>");
                            sesssion.invalidate();
