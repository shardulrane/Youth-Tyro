<%-- 
    ...
    Created on : Jun 6, 2016, 12:04:05 AM
    Author     : Shardul Rane
--%>
	...
	function processform()
			{
				...
				if(document.attandance.class.value=="0")
				{

					alert("Please Select The Class");
					document.attandance.class.focus();
					return false;
				}


				if(document.attandance.semester.value=="0")
				{

					alert("Please Select The Semester");
					document.attandance.semester.focus();
					return false;
				}

				if(document.attandance.subject.value=="0")
				{

					alert("Please Select The Subject");
					document.attandance.subject.focus();
					return false;
				}

				if(document.attandance.type_of_lect.value=="0")
				{

					alert("Please Select The Type Of Lectures");
					document.attandance.type_of_lect.focus();
					return false;
				}
				else
				{
