<%-- 
    Document   : viewdoubts
    Created on : Jun 1, 2016, 5:52:34 PM
    Author     : Shardul Rane
--%>
                                ...
                                if (xmlhttp.readyState==4 && xmlhttp.status==200)
                                  {
                                     ...
                                     document.getElementById("doubtres").innerHTML=xmlhttp.responseText;

                                  }
                        }
                        xmlhttp.open("GET","showdoubts.jsp?q="+str,true);
                        //alert("Sucess HTTP2")
                        xmlhttp.send();
                        //alert("Sucess HTTP3")
                    }

                    function sendres(str,str1)
                    {
                        var sol=document.getElementById(str1).value;
                        //alert(sol);
...
//var userType= usertype .options[usertype .selectedIndex].value;
//var uname=document.search;
var urls="submitres.jsp?combo="+str+"&sol="+sol;
if (window.XMLHttpRequest)
  {
  xmlhttp=new XMLHttpRequest();
  }
