...
<%
    ...
    try {
        ...
        Connection con = DriverManager.getConnection("jdbc:sqlserver://SHARK;databaseName=tyro;user=tyro;password=tyro123");
            PreparedStatement ps1 = con.prepareStatement("SELECT Sub FROM classreg WHERE Class =? And Sem=? and Div=? and uid=?");
            ps1.setString(1, classes);
            ps1.setString(2, sem);
            ps1.setString(3, div);
            ps1.setString(4, (String)session.getAttribute("uid"));
