<%-- 
    Document   : officesetprofile
    Created on : Jun 5, 2016, 8:52:20 PM
    Author     : Shardul Rane
--%>
...
<%
           ...
           if(resultset4.next())
           {
				...
				<form id="rootwizard-2" action="../updateofficeprofile" method="post" class="form-wizard validate" enctype="multipart/form-data">
