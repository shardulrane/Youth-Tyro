<%-- 
    Document   : getfaculty
    Created on : May 26, 2016, 1:16:15 PM
    Author     : Shardul Rane
--%>
...
//gets the department of the employee to allot class
    ...
    try {
        ...
        PreparedStatement ps1 = con.prepareStatement("SELECT * FROM register_users WHERE e_dept =? AND cid =? and type='Teacher' or type='HOD' or type='Special'");
