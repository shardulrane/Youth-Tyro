<%-- 
    Document   : uploadnotice
    Created on : May 24, 2016, 6:48:13 PM
    Author     : Shardul Rane
--%>
...
<html lang="en">
	...
	<head>
		...
		<title>Tyro | Upload Notice</title>
 ...
 <div id="searchres">
				...
				<div class="panel-heading">
							...
							<div class="panel-body">
                                                            <form role="form" action="../uploadnotice" class="form-horizontal form-groups-bordered" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label for="field-1" class="col-sm-3 control-label">Title</label> 
										<div class="col-sm-5"> 
											<input type="text" class="form-control" id="title" name="title" placeholder="Enter The Title For The Notice..."> 
										</div>
								</div>	
								<div class="form-group">
										<label class="col-sm-3 control-label">Select Type</label> 
										<div class="col-sm-5">
                                                                                    <select name="typeofnotice" id="typeofnotice" class="selectboxit" data-first-option="false">
												<option>Select Class</option>
												<option value="University Notices">University Notices</option>
												<option value="College Notices">College Notices</option>
										...
										<div class="form-group">
											<label class="col-sm-3 control-label">Select A File</label> 
                                                                                        <div class="col-sm-5"> <input id="notice_file" name="notice_file" type="file" accept=".pdf" class="form-control file2 inline btn btn-primary" data-label="<i class='glyphicon glyphicon-file'></i> Browse" /> </div>
												</div>																
									...
									<center><button type="submit" class="btn btn-green btn-icon">
													...
													<button type="reset" class="btn btn-red btn-icon">
															Reset
													<i class="entypo-cancel"></i> </button></center>
													</div>
							</div>
