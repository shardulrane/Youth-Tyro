<%-- 
    Document   : hodsetprofile
    Created on : May 30, 2016, 11:25:37 AM
    Author     : Shardul Rane
--%>
...
<%
           ...
           if(resultset4.next())
           {
				...
				<form id="rootwizard-2" action="../updatehodprofile" method="post" class="form-wizard validate" enctype="multipart/form-data">
