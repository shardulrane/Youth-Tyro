<%-- 
    ...
    Created on : Jun 3, 2016, 3:21:18 PM
    Author     : Shardul Rane
--%>
...
<%
    ...
    try {
        ...
        Connection con = DriverManager.getConnection("jdbc:sqlserver://SHARK;databaseName=tyro;user=tyro;password=tyro123");
            PreparedStatement ps = con.prepareStatement("select * from question_papers where c_id=? and u_id=? and classes like '%"+dept+"%' and sem=?");
            ps.setString(1,cid); 
             ps.setString(2,uid);
            ps.setString(3,sem);
