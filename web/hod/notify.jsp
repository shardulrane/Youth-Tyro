...
function processform()
			{
				...
				if(document.notify.level.value=="0")
				{

					alert("Please Select The Level Of Notification");
					document.notify.level.focus();
					return false;
				}

				if(document.notify.title.value=="")
				{

					alert("Please Enter The Title For The Notification");
					document.notify.title.focus();
					return false;
				}
				...
				if(document.notify.desp.value=="")
				{
					...
					alert("Please Enter The Description For The Notification");
 ...
 <div id="searchres">
			...
			<div class="panel-body">
								<form role="form" name="notify" action="notify.java" class="form-horizontal form-groups-bordered">
									<strong>Notify Students</strong> <br /> 
								
						<div class="form-group">
										<label class="col-sm-3 control-label">Level</label> 
										<div class="col-sm-5">
											<select name="level" class="selectboxit" data-first-option="false">
												<option value="0">Select Level Of Notification</option>
						...
						<div class="form-group">
										...
										<div class="col-sm-5"> 
											<input type="text" class="form-control" id="title" name="title" placeholder="Enter The Title For The Notification..."> 
										</div>
						</div>	
						<div class="form-group">
										<label for="field-ta" class="col-sm-3 control-label">Description</label> 
										<div class="col-sm-5"> <textarea class="form-control" id="desp" name="desc" placeholder="Enter The Description Of The Notification here..."></textarea> </div>
						</div>
						<div class="form-group">
								<center>
