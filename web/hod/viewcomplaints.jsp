...
function showhide(id,id1) {
 ...
 <div id="searchres">
								...
								<form role="form" name="notify" action="notify.java" class="form-horizontal form-groups-bordered">
									<strong>Complaint Box</strong> <br /> 
								
						<div class="form-group">
										<label for="field-ta" class="col-sm-3 control-label">Students Description from data base</label> 
										<div class="col-sm-5"> <textarea class="form-control" disabled="true" id="complaint" name="complaint" placeholder="The Complaint will come from database..."></textarea> </div>
						</div>
						<div class="form-group">
								<center>	<button type="button" class="btn btn-green btn-icon" onclick="showhide('uniquename','uniquename1')" >
									Resolve
						...
						<div class="form-group" id="uniquename" style="display:none;">
										<label for="field-ta" class="col-sm-3 control-label">Enter The Action Taken</label> 
										<div class="col-sm-5"> <textarea required="required" class="form-control" id="resolve" name="resolve" placeholder="Enter The Action Taken..."></textarea> </div>
						</div>
						<div class="form-group" id="uniquename1" style="display:none;">
										<center>	<button type="button" class="btn btn-green btn-icon">
															Submit
															<i class="entypo-check"></i></button>
															&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
