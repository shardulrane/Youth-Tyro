<%-- 
    Document   : uploadquestionpaper
    Created on : May 25, 2016, 11:41:24 AM
    Author     : Shardul Rane
--%>
...
<html lang="en">
	...
	<head>
		...
		<title>Tyro | Upload Question Paper</title>
...
xmlhttp.send();
 ...
 <div id="searchres">
                            ...
                            <form role="form" method="post" name="questionpaper" action="../uploadpaper" class="form-horizontal form-groups-bordered"  enctype="multipart/form-data">
									<strong>Upload Question Paper</strong> <br /> 
           ...
           resultset4=ps3.executeQuery();
                ...
                <form role="form" class="form-horizontal form-groups-bordered" action="../classreg">
						...
						<div class="form-group">
										<label for="field-1" class="col-sm-3 control-label">Type Of Question Paper</label> 
										<div class="col-sm-5"> 
                                                                                    <select name="type_of_paper" id="type_of_paper" class="selectboxit selectboxit visible selectboxit-enabled selectboxit-btn" data-allow-clear="true" required="required" >
						...
						<div class="form-group">
										<label for="field-1" class="col-sm-3 control-label">Year Of Question Paper</label> 
										<div class="col-sm-5"> 
                                                                                    <input type="month" name="ayear" id="ayear" class="form-control"> 
										</div>
						</div>
									<div class="form-group">
										...
										<div class="col-sm-5">
											<div class="fileinput fileinput-new" data-provides="fileinput">
												...
												<div> 
													...
													<span class="fileinput-exists">Change</span> 
                                                                                                        <input type="file" name="..." id="..." accept="image/*"> </span>
											...
											<div class="form-group">
										<center>	<button type="submit" class="btn btn-green btn-icon">
															Submit
...
%>                                  
	...
	<link rel="stylesheet" href="../assets/css/font-icons/font-awesome/css/font-awesome.min.css" id="style-resource-1">
		...
		<script src="../assets/js/tyro-chat.js" id="script-resource-10"></script> 
