<%-- 
    Document   : viewnotice
    Created on : Jun 3, 2016, 7:49:30 PM
    Author     : Shardul Rane
--%>
...
//var userType= usertype .options[usertype .selectedIndex].value;
//var uname=document.search;
var urls="shownotice.jsp?level="+level;
if (window.XMLHttpRequest)
  {
  xmlhttp=new XMLHttpRequest();
  }
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4)
    {
        document.getElementById("noticeres").innerHTML=xmlhttp.responseText;
     }
  }
xmlhttp.open("GET",urls,true);
xmlhttp.send();
...
//var userType= usertype .options[usertype .selectedIndex].value;
//var uname=document.search;
var urls="shownotice1.jsp?level="+level+"&to="+to+"&from="+from;
if (window.XMLHttpRequest)
  {
  xmlhttp=new XMLHttpRequest();
  }
...
xmlhttp.send();
 ...
 <div id="searchres">
			...
			<div class="panel-body">
								<form role="form" class="form-horizontal form-groups-bordered" name="../viewnotice">
								<div class="form-group">
										<label class="col-sm-3 control-label">Level Of Notice</label> 
										<div class="col-sm-5">
                                                                                    <select name="level" id="level" class="form-control" data-first-option="false" onchange="showdata()">
												<option>Select Level of Notice</option>
												<option value="University Notices">University</option>
												<option value="College Notices">College</option>
												<option value="Department Notices">Department</option>
											</select>
										</div>
								</div>
								<div class="form-group">
										...
										<div class="col-sm-3">
                                                                                    ...
                                                                                    <input type="date" name="to" id="to" class="form-control" onchange="showdata1()">
                                                                                </div>
                                                                        <div class="col-sm-3"></div>
                                                                    </center>
                                                                </div>
                                                                    <div id="noticeres" name="noticeres">
                                                                    </div>
                        </div>
...
%>                                  
	...
	<link rel="stylesheet" href="../assets/js/dropzone/dropzone.css" id="style-resource-1">
		...
		<script src="../assets/js/moment.min.js" id="script-resource-13"></script>
		<script src="../assets/js/daterangepicker/daterangepicker.js" id="script-resource-14"></script> 
