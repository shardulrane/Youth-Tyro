<%-- 
    Document   : viewquestionpaper
    Created on : Jun 3, 2016, 1:57:46 PM
    Author     : Shardul Rane
--%>
...
//var userType= usertype .options[usertype .selectedIndex].value;
//var uname=document.search;
var urls="showsubpapers.jsp?sem="+sem+"&sub="+sub+"&dept="+dept+"&type="+type+"&classs="+classes;
if (window.XMLHttpRequest)
  {
  xmlhttp=new XMLHttpRequest();
  }
...
//var userType= usertype .options[usertype .selectedIndex].value;
//var uname=document.search;
var urls="showdeptpapers.jsp?dept="+dept;
if (window.XMLHttpRequest)
  {
  xmlhttp=new XMLHttpRequest();
  }
...
//var userType= usertype .options[usertype .selectedIndex].value;
//var uname=document.search;
var urls="showsempapers.jsp?dept="+dept+"&classs="+classes+"&sem="+sem;
if (window.XMLHttpRequest)
  {
  xmlhttp=new XMLHttpRequest();
  }
...
//var userType= usertype .options[usertype .selectedIndex].value;
//var uname=document.search;
var urls="showsubjectpapers.jsp?dept="+dept+"&classs="+classes+"&sem="+sem+"&sub="+sub;
if (window.XMLHttpRequest)
  {
  xmlhttp=new XMLHttpRequest();
  }
...
//var userType= usertype .options[usertype .selectedIndex].value;
//var uname=document.search;
var urls="showtypepapers.jsp?dept="+dept+"&classs="+classes+"&sem="+sem+"&sub="+sub+"&type="+type;
if (window.XMLHttpRequest)
  {
  xmlhttp=new XMLHttpRequest();
  }
...
showdeptdata();
 ...
 <div id="searchres">
           ...
           ResultSet resultset4=ps3.executeQuery();
			...
			<form role="form" class="form-horizontal form-groups-bordered" name="viewpapers">
								<div class="form-group">
										<label class="col-sm-3 control-label">Department</label> 
										<div class="col-sm-5">
                                                                                    <select name="department" id="department" class="form-control" onchange="deptsend(this.value)">
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
                                                                                    <select name="class" id="class" class="form-control" onchange="classsend(this.value)">
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
                                                                                    <select name="sub" id="sub" class="form-control" onchange="showsubjectdata()">
											</select>
										</div>
								</div>
                                                                <div class="form-group">
										...
										<div class="col-sm-5">
                                                                                    <select name="type" id="type" class="form-control" onchange="showtypedata()">
