...
<html lang="en">
	...
	<head>
		...
		<title>Tyro | Allot Special</title>
...
xmlhttp.send();
     ...
     function senddept(str)
    {
       // alert(str);
        ...
        xmlhttp.open("GET","getfaculty.jsp?q="+str,true);
        //alert("Sucess HTTP2")
        xmlhttp.send();
       // alert("Sucess HTTP3")
					...
					<div class="col-md-12">
						<div class="panel panel-primary" data-collapsed="0">							
							<div class="panel-body">
								<form role="form" name="allot" class="form-horizontal form-groups-bordered" action="../submitspecial">
									<div class="form-group">
										<label class="col-sm-3 control-label">Department</label> 
										<div class="col-sm-5">
                                                                                    <select name="department" id="department" class="form-control" data-first-option="false" onchange="senddept(this.value)">
											...
											<br>
                                                                                        <div class="form-group">
                                                                                        <label class="col-sm-3 control-label">Allot A Special Teacher</label> 
										<div class="col-sm-5">
                                                                                    <select name="teacher" id="teacher" class="form-control" data-allow-clear="true" required="required" data-placeholder="Select one teacher">
												
											</select>
											<br>
                                                                                        
										<center><button type="submit" class="btn btn-green btn-icon" >
									Grant Privilege<i class="entypo-check"></i></button>
									</center>
										</div>
									</div>
