...
function processform()
			{
				...
				if(document.club.title.value=="")
				{

					alert("Please Enter The Title Of The Club...!!");
					document.club.title.focus();
					return false;
				}

				if(document.club.goal.value=="")
				{

					alert("Please Enter The Goal Of The Club");
					document.club.goal.focus();
					return false;
				}

				if(document.club.stud.value=="0")
				{

					alert("Please Select The Student Admin For The Club");
					document.club.stud.focus();
					return false;
				}
				else
				{
 ...
 <div id="searchres">
								...
								<form role="form" name="club" action="createclub.java" class="form-horizontal form-groups-bordered">
									<strong>Create A Club</strong> <br /> 
								
						<div class="form-group">
										<label for="field-1" class="col-sm-3 control-label">Name Of The Club</label> 
										<div class="col-sm-5"> 
											<input type="text" class="form-control" id="title" name="title" placeholder="Enter The Name Of The Club"> 
										</div>
						</div>	
						<div class="form-group">
										<label for="field-ta" class="col-sm-3 control-label">Goal Of The Club</label> 
										<div class="col-sm-5"> <textarea class="form-control" id="desp" name="goal" placeholder="Enter The Goal Of The Club here..."></textarea> </div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">Select A Student Admin</label> 
										<div class="col-sm-5">
											<select name="stud" class="select2" data-allow-clear="true" required="required" >
												<option value="0">Select One Student Admin</option>
												<optgroup label="Students Of Your Department">
													<option value="Sandeep Dongri">Sandeep Dongri</option>
													<option value="Jay Arora">Jay Arora</option>
													<option value="Abc Singh">Abc Singh</option>
													<option value="4">Katrina Kaif</option>
						...
						<div class="form-group">
								...
								<button type="submit" class="btn btn-green btn-icon" onclick="return processform();" >
									Create Club<i class="entypo-check"></i></button>
									</center>
						</div>
