...
<html lang="en">
	...
	<head>
		...
		<title>Tyro | Notify Student</title>
...
function processform()
			{
				...
				if(document.notify.dept.value=="0")
				{

					alert("Please Select The Department");
					document.notify.dept.focus();
					return false;
				}


				if(document.notify.year.value=="0")
				{

					alert("Please Select The Year");
					document.notify.year.focus();
					return false;
				}

				if(document.notify.sub.value=="0")
				{

					alert("Please Select The Subject");
					document.notify.sub.focus();
					return false;
				}

				if(document.notify.type.value=="0")
				{

					alert("Please Select The Type Of Notification");
					document.notify.type.focus();
					return false;
				}


				if(document.notify.desp.value=="")
				{

					alert("Please Enter The Description Of The Notification In Detail...!!");
					document.notify.desp.focus();
					return false;
				}
 ...
 <div id="searchres">
                                ...
                                <!-- Content to be addded here-->
			<div class="panel-body">
								<form role="form" name="notify" action="notifystudent.java" class="form-horizontal form-groups-bordered">
									<strong>Notify Students</strong> <br /> 
								
						<div class="form-group">
										<label for="field-1" class="col-sm-3 control-label">Select Department</label> 
										<div class="col-sm-5"> 
											<select name="dept" class="select2" data-allow-clear="true" required="required" >
												<option value="0">Select Department</option>
												<optgroup label="Select Your Department">
													<option value="Computers">Computers</option>
													<option value="I.T">I.T</option>
													<option value="Chemistry">Chemistry</option>
													<option value="Baki KA Database se">Baki ka database se</option>
						...
						<div class="form-group">
										<label for="field-1" class="col-sm-3 control-label">Select Year</label> 
										<div class="col-sm-5"> 
											<select name="year" class="select2" data-allow-clear="true" required="required" >
						...
						<div class="form-group">
										...
										<div class="col-sm-5"> 
											<select name="sub" class="select2" data-allow-clear="true" required="required" >
												<option value="0">Select Subject</option>
												<optgroup label="Select Year">
													<option value="Ect">Electronics </option>
						...
						<div class="form-group">
										<label for="field-1" class="col-sm-3 control-label">Type Of Notification</label> 
										<div class="col-sm-5"> 
											<select name="type" class="select2" data-allow-clear="true" required="required" >
						...
						<div class="form-group">
										<label for="field-ta" class="col-sm-3 control-label">Description Of Notification</label> 
										<div class="col-sm-5"> <textarea class="form-control" id="desp" name="desp" placeholder="Enter Description here..."></textarea> </div>
						</div>
						<div class="form-group">
								<center>
								<button type="submit" class="btn btn-green btn-icon" onclick="return processform();" >
									Send Notification<i class="entypo-check"></i></button>
									</center>
						</div>
