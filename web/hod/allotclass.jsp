...
xmlhttp.send();
            ...
            function yearsend(str)
    {
        ...
        xmlhttp.open("GET","getsem.jsp?q="+str,true);
        //alert("Sucess HTTP2")
        xmlhttp.send();
       // alert("Sucess HTTP3")
              ...
              function semsend(str)
    {
     ...
     var urls="getsub.jsp?q="+str+"&dept="+dept;
       ...
       //alert(str);
        ...
        xmlhttp.onreadystatechange=function()
          ...
          if (xmlhttp.readyState==4 && xmlhttp.status==200)
            {
             //  alert(xmlhttp.responseText);
              document.getElementById("paper").value=xmlhttp.responseText;
            
            }
          }
        xmlhttp.open("GET","getpaper.jsp?q="+str,true);
        //alert("Sucess HTTP2")
        xmlhttp.send();
       // alert("Sucess HTTP3")
      
    }
          function sendedept(str)
    {
        ...
        xmlhttp.open("GET","getemp.jsp?q="+str,true);
        //alert("Sucess HTTP2")
        xmlhttp.send();
       // alert("Sucess HTTP3")
 ...
 <div id="searchres">
           ...
           ps3.setString(1, eid);
           ps3.setString(2,cid);
           resultset4=ps3.executeQuery();
                %>				
                                    
                <form role="form" class="form-horizontal form-groups-bordered" action="../classreg">
								<div class="form-group">
										<label class="col-sm-3 control-label">Department</label> 
										<div class="col-sm-5">
                                                                                    <select name="department" id="department" class="form-control" data-first-option="false">
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
                                                                                    <select name="year" id="year" class="form-control" autocomplete="yes" onchange="yearsend(this.value)">
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
                                                                                    <select name="sem" id="sem" class="form-control" onchange="semsend(this.value)">
                                                                                    </select>
										</div>
								</div>
								<div class="form-group">
										...
										<div class="col-sm-5">
											<select name="sub" id="sub" onchange="subsend(this.value)" class="form-control">
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
                                                                                    <input type="text" name="paper" id="paper" readonly="true" class="form-control">
										</div>
								</div>
								<div class="form-group">
										...
										<div class="col-sm-5">
											<input type="text" name="div" id="div" class="form-control">
                                                                                        		...
                                                                                        		<%
                  PreparedStatement ps5=con.prepareStatement("select Distinct Dept_ID,Dept_Name from college_dept where College_Code=?");
           ps5.setString(1, cid);
          resultset5=ps5.executeQuery();
                   %>
								<div class="form-group">
										<label class="col-sm-3 control-label">Department</label> 
										<div class="col-sm-5">
                                                                                    <select name="edepartment" id="edepartment" class="form-control" onchange="sendedept(this.value)">
                                                                                        <option value="0">Select The Teacher's Department</option>
											   <%  while(resultset5.next()){ %>
                                                                                                        <option value="<%= resultset5.getString("Dept_ID")%>"><%= resultset5.getString("Dept_Name")%></option>
                                                                                                        <% } %>		
											</select>
										</div>
								</div>
								...
								<div class="form-group">
										<label class="col-sm-3 control-label">Theory</label> 
										<div class="col-sm-5">
										<ul class="icheck-list">
                                                                                    <li> <input tabindex="5" type="checkbox" class="icheck-15" name="types" id="types" value="Lecture"> <label for="minimal-checkbox-1-15">Theory</label> </li>
										</ul>
										</div>
								</div>
								<div class="form-group">
										<label class="col-sm-3 control-label">Practical</label> 
										<div class="col-sm-5">
										<ul class="icheck-list">
                                                                                    <li> <input tabindex="5" type="checkbox" class="icheck-15" id="type" name="type" value="Practical"> <label for="minimal-checkbox-1-15">Practical</label> </li>
										</ul>
										</div>
								</div>
								<div class="form-group">
										...
										<div class="col-sm-5">
										<ul class="icheck-list">
											<li> <button type="Submit" class="btn btn-success" class="col-sm-3">Submit</button> &nbsp;&nbsp;&nbsp;&nbsp;
								<button type="reset" class="btn">Reset</button>		 </li>
										</ul>
										</div>
								</div>		
...
%>                                  
	...
	<link rel="stylesheet" href="../assets/js/dropzone/dropzone.css" id="style-resource-1">
		<link rel="stylesheet" href="../assets/js/icheck/skins/minimal/_all.css" id="style-resource-5">		
		<link rel="stylesheet" href="../assets/js/icheck/skins/polaris/polaris.css" id="style-resource-9">
		<link rel="stylesheet" href="../assets/js/icheck/skins/line/_all.css" id="style-resource-10">
