<%-- 
    Document   : deletepaper
    Created on : Jun 3, 2016, 3:32:48 PM
    Author     : Shardul Rane
--%>
...
<%
        ...
        Connection con = DriverManager.getConnection("jdbc:sqlserver://SHARK;databaseName=tyro;user=tyro;password=tyro123");
            ...
            PreparedStatement ps = con.prepareStatement("DELETE FROM question_papers WHERE q_id=?");
            ps.setInt(1, id);
            ...
            ps1.setString(2, "Papers");
            ps1.setInt(3, id);
            int j=ps1.executeUpdate();
            if(j!=0)
            {
                
                out.println("<script>alert('Selected Paper Has Been Deleted Successfully !!!')\n" + "  window.location.href='viewquestionpaper.jsp';\n" + "</script>");
                        //sesssion.invalidate();
