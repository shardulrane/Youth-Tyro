<%-- 
    ...
    Created on : May 29, 2016, 8:27:52 PM
    Author     : Shardul Rane
--%>
...
xmlhttp.send();
    ...
    function sendclass(str)
     ...
     var urls="getclasssub.jsp?q="+str+"&classes="+classes;                
        var xmlhttp=new XMLHttpRequest();
                        xmlhttp.onreadystatechange=function()
                        {
                                if (xmlhttp.readyState==4 && xmlhttp.status==200)
 ...
 <div id="searchres">
                            ...
                            <form role="form" method="post" name="questionpaper" action="../uploadpaper_spec" class="form-horizontal form-groups-bordered"  enctype="multipart/form-data">
           ...
           resultset4=ps3.executeQuery();
                %>
										...
										<div class="col-sm-5"> 
                                                                                    <select name="class" id="class" class="select2" data-allow-clear="true" required="required" onchange="sendclass(this.value)">
						...
						<div class="form-group">
										...
										<div class="col-sm-5"> 
                                                                                    <select name="sem" id="sem" onchange="semsend(this.value)" class="form-control" required="required">
						...
						<div class="form-group">
										...
										<div class="col-sm-5"> 
                                                                                    <select name="sub" id="sub" class="form-control" required="required" >
						...
						<div class="form-group">
										...
										<div class="col-sm-5"> 
                                                                                    <input type="month" name="year" id="year" class="form-control"> 
										</div>
						</div>
									<div class="form-group">
