<%-- 
    Document   : showsubnotes
    Created on : Jun 2, 2016, 11:12:57 PM
    Author     : Shardul Rane
--%>
...
<%
    ...
    try {
        ...
        Connection con = DriverManager.getConnection("jdbc:sqlserver://SHARK;databaseName=tyro;user=tyro;password=tyro123");
         if (classs != "") {
             String query=null;
            PreparedStatement ps = con.prepareStatement("select * from College_notes where classes=? and u_id=? and c_id=? and sem=? and div=? and sub=?");
