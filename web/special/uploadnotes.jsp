<%-- 
    Document   : givenotes
    Created on : May 29, 2016, 8:12:16 PM
    Author     : Shardul Rane
--%>
...
function sendclass(str)
 ...
 <div id="searchres">
							...
							<div class="panel-body">
                                                            <form role="form" class="form-horizontal form-groups-bordered" action="../uploadnotes_spec" name="hoduploadnotes" method="post" enctype="multipart/form-data">
			<%
                ...
                %>	
						...
						<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-5"> 
											<input type="text" class="form-control" id="title" name="title" placeholder="Enter The Title For The Notes..."> 
										</div>
								</div>	
										<div class="form-group">
											<label class="col-sm-3 control-label">Select A File</label> 
                                                                                        <div class="col-sm-5"> <input type="file" name="notes" id="notes" class="form-control file2 inline btn btn-primary" accept=".docx,.ppt,.pptx,.doc,.jpeg,.png,.pdf,.xls,.xlsx" data-label="<i class='glyphicon glyphicon-file'></i> Browse" /> </div>
												</div>																
