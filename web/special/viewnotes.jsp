<%-- 
    Document   : viewnotes
    Created on : Jun 3, 2016, 12:58:10 AM
    Author     : Shardul Rane
--%>
...
//var userType= usertype .options[usertype .selectedIndex].value;
//var uname=document.search;
var urls="shownotes.jsp?classs="+classs+"&sem="+sem+"&div="+div+"&sub="+sub;
if (window.XMLHttpRequest)
  {
  xmlhttp=new XMLHttpRequest();
  }
...
//var userType= usertype .options[usertype .selectedIndex].value;
//var uname=document.search;
var urls="showsemnotes.jsp?classs="+classs+"&sem="+sem;
if (window.XMLHttpRequest)
  {
  xmlhttp=new XMLHttpRequest();
  }
...
//var userType= usertype .options[usertype .selectedIndex].value;
//var uname=document.search;
var urls="showdivnotes.jsp?classs="+classs+"&sem="+sem+"&div="+div;
if (window.XMLHttpRequest)
  {
  xmlhttp=new XMLHttpRequest();
  }
...
//var userType= usertype .options[usertype .selectedIndex].value;
//var uname=document.search;
var urls="showsubnotes.jsp?classs="+classs+"&sem="+sem+"&div="+div+"&sub="+sub;
if (window.XMLHttpRequest)
  {
  xmlhttp=new XMLHttpRequest();
  }
           ...
           ResultSet resultset4=ps3.executeQuery();
				...
				<div class="panel-body">
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<select name="class" id="class" class="form-control" data-first-option="false" onchange="sendclass(this.value)">
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
											<select name="div" id="div" class="form-control" data-first-option="false" onchange="senddiv(this.value)">
											</select>
										</div>
								</div>	
								<div class="form-group">
										...
										<div class="col-sm-5">
                                                                                    <select name="sub" id="sub" class="form-control" data-first-option="false" onchange="showsubdata()">
											</select>
										</div>
								</div>
