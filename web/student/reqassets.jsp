<%-- 
    Document   : reqassets
    Created on : Jun 5, 2016, 7:04:36 PM
    Author     : Shardul Rane
--%>
...
<html lang="en">
	...
	<head>
		...
		<title>Tyro | Request Assets</title>
...
xmlhttp.send();
 ...
 <div id="searchres">
				...
				<form role="form" name="assetrequests" action="../submitassetrequest" class="form-horizontal form-groups-bordered">
									<strong>Request An Asset</strong> <br /> 
				<div class="form-group">
										<label for="field-1" class="col-sm-3 control-label">Asset</label> 
										<div class="col-sm-5"> 
											<select name="asset" id="asset" class="select2" data-allow-clear="true" required="required" >
												...
												<optgroup label="Select Asset">
													...
													<option value="Duplicate Fee Receipt">Duplicate Fee Receipt</option>
													<option value="Duplicate Result">Duplicate Result</option>
							...
							<div class="form-group">
										<label for="field-ta" class="col-sm-3 control-label">Reason</label> 
                                                                                <div class="col-sm-5"> <textarea class="form-control autogrow" placeholder="Write a reason for requesting the above asset" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 48px;" id="reason" name="reason"></textarea> </div>
						</div>
						<div class="form-group">
								<center>
								<button type="submit" class="btn btn-green btn-icon" onclick="return processform();" >
									Request Asset<i class="entypo-check"></i></button>
									</center>
						</div>
						</form>
				<br>			
