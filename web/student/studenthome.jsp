	...
	<body class="page-body">
		...
		<div class="page-container">
           ...
           Connection con=DriverManager.getConnection("jdbc:sqlserver://SHARK;databaseName=tyro;user=tyro;password=tyro123");
              ...
              int countofrequest,countofnotification;
              ...
              if(getcountnot.next())
              {
               ...
               PreparedStatement notific=con.prepareStatement("select count(*) as numberofnotification from notification where s_uid=? and status=?");
               notific.setString(1, uid);
               notific.setString(2,"Unseen");
                ResultSet getnoti=notific.executeQuery();
                if(getnoti.next())
                {
                    countofnotification=getnoti.getInt("numberofnotification");
                   %>
                   <ul class="user-info pull-left pull-right-xs pull-none-xsm">
							<!-- Raw Notifications --> 
							<li class="notifications dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true"> <i class="entypo-attention"></i> <span class="badge badge-info"><%=countofrequest+countofnotification%></span> </a> 
								<ul class="dropdown-menu">
									<li>
							    <ul class="dropdown-menu-list scroller">
											<li class="unread notification-success"> <a href="showfriendrequest.jsp"> <i class="entypo-user-add pull-right"></i> <span class="line"> <strong>You Have <%=countofrequest%> Friend Requests </strong> </span> </a> 
                                                                                        ...
                                                                                        <li class="unread notification-success"> <a href="notifications.jsp"> <i class="entypo-user-add pull-right"></i> <span class="line"> <strong>You Have <%=countofnotification%> Notifications Unseen </strong> </span> </a> 
											</li>
											<%}}%>
										</ul>
									</li>
