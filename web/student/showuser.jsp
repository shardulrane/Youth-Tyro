                                          ...
                                          else
{
                                             %>
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="profile-buttons"> <a href="../sendstudrequest?uid1=<%=(String)request.getSession().getAttribute("uid")%>&uid2=<%=uid%>" class="btn btn-default"> <i class="entypo-user-add"></i>
								Send Friend Request
								</a> 
							</div>
						</div>
