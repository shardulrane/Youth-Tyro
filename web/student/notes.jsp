<%-- 
    Document   : notes
    Created on : Jun 3, 2016, 1:13:14 AM
    Author     : Shardul Rane
--%>
...
<html lang="en">
	...
	<head>
		...
		<title>Tyro | Notes Section</title>
...
//var userType= usertype .options[usertype .selectedIndex].value;
//var uname=document.search;
var urls="shownotes.jsp?&sem="+sem;
if (window.XMLHttpRequest)
  {
  xmlhttp=new XMLHttpRequest();
  }
...
//var userType= usertype .options[usertype .selectedIndex].value;
//var uname=document.search;
var urls="showsemnotes.jsp?sem="+sem+"&sub="+sub;
if (window.XMLHttpRequest)
  {
  xmlhttp=new XMLHttpRequest();
  }
           ...
           if(resultset5.next())
           {
				...
				<div class="panel-body">
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
                                                                                    <select name="sub" id="sub" class="form-control" onchange="showsemdata(this.value)">
											</select>
										</div>
								</div>
