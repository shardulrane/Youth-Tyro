<%-- 
    Document   : universitynotice
    Created on : Jun 5, 2016, 6:06:23 PM
    Author     : Shardul Rane
--%>
...
<html lang="en">
	...
	<head>
		...
		<title>Tyro | University Notices</title>
    ...
    String cid = (String)request.getSession().getAttribute("cid");
        ...
        PreparedStatement ps5 = con.prepareStatement("SELECT * FROM register_users WHERE uid=? and cid=?");
                    ...
                    if (rs5.next()) {
                      ...
                      String type="University Notices";
            PreparedStatement ps6 = con.prepareStatement("select * from notices_college where College_Code=? and Ntype=? order by Upload_Date desc");
            ps6.setString(1, cid);
