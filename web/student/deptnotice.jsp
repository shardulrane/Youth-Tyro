<%-- 
    Document   : deptnotice
    Created on : Jun 5, 2016, 5:49:04 PM
    Author     : Shardul Rane
--%>
...
<html lang="en">
	...
	<head>
		...
		<title>Tyro | Department Notices</title>
    ...
    String cid = (String)request.getSession().getAttribute("cid");
        ...
        PreparedStatement ps5 = con.prepareStatement("SELECT * FROM register_users WHERE uid=? and cid=?");
                    ...
                    if (rs5.next()) {
                      ...
                      String type="Department Notices";
            PreparedStatement ps6 = con.prepareStatement("select * from notices_college where College_Code=? and Ntype=? and Department=? order by Upload_Date desc");
            ps6.setString(1, cid);
            ps6.setString(2, type);
            ps6.setString(3, dept);
                  ...
                  %>
                    <tr>
									...
									<td><%=rs6.getDate(7)%></td>
                                                                       ...
                                                                       <td><a href="../downloadnotice?id=<%=rs6.getInt(1)%>"><button type="button" class="btn btn-black">Download <i class="entypo-down"></i> </button></a></td>
